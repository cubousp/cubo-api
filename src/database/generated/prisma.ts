...
enum ActivityOrderByInput {
  ...
  kind_ASC
  kind_DESC
  visibleForParticipants_ASC
  visibleForParticipants_DESC
  totalVacancies_ASC
  totalVacancies_DESC
...
input ActivityWhereInput {
  ...
  """All values that are not equal to given value."""
  kind_not: ActivityKind

  """All values that are contained in given list."""
  kind_in: [ActivityKind!]

  """All values that are not contained in given list."""
  kind_not_in: [ActivityKind!]
  visibleForParticipants: Boolean

  """All values that are not equal to given value."""
  visibleForParticipants_not: Boolean
  totalVacancies: Int

  """All values that are not equal to given value."""
  totalVacancies_not: Int

  """All values that are contained in given list."""
  totalVacancies_in: [Int!]

  """All values that are not contained in given list."""
  totalVacancies_not_in: [Int!]

  """All values less than the given value."""
  totalVacancies_lt: Int

  """All values less than or equal the given value."""
  totalVacancies_lte: Int

  """All values greater than the given value."""
  totalVacancies_gt: Int

  """All values greater than or equal the given value."""
  totalVacancies_gte: Int
  shortDescription: String
...
input ParticipantWhereInput {
  ...
  """All values that are not equal to given value."""
  kind_not: ParticipantKind

  """All values that are contained in given list."""
  kind_in: [ParticipantKind!]

  """All values that are not contained in given list."""
  kind_not_in: [ParticipantKind!]
  enrolled_every: InscriptionWhereInput
  enrolled_some: InscriptionWhereInput
  enrolled_none: InscriptionWhereInput
}
...
export type ActivityKind =   'LECTURE' |
  'WORKSHOP' |
  'HANDSON' |
  'SURGERY' |
  'STAND' |
...
export type ParticipantKind =   'GRADUATING_FOUSP' |
  'POS_GRADUATING_FOUSP' |
  'EXTERNAL_PARTICIPANT'
...
export interface ParticipantWhereInput {
  ...
  role?: AuthRole
  role_not?: AuthRole
  role_in?: AuthRole[] | AuthRole
  role_not_in?: AuthRole[] | AuthRole
  authId?: String
  authId_not?: String
  ...
  kind?: ParticipantKind
  kind_not?: ParticipantKind
  kind_in?: ParticipantKind[] | ParticipantKind
  kind_not_in?: ParticipantKind[] | ParticipantKind
  enrolled_every?: InscriptionWhereInput
  enrolled_some?: InscriptionWhereInput
  enrolled_none?: InscriptionWhereInput
}
...
export interface ActivityWhereInput {
  ...
  kind?: ActivityKind
  kind_not?: ActivityKind
  kind_in?: ActivityKind[] | ActivityKind
  kind_not_in?: ActivityKind[] | ActivityKind
  visibleForParticipants?: Boolean
  visibleForParticipants_not?: Boolean
  totalVacancies?: Int
  totalVacancies_not?: Int
  totalVacancies_in?: Int[] | Int
  totalVacancies_not_in?: Int[] | Int
  totalVacancies_lt?: Int
  totalVacancies_lte?: Int
  totalVacancies_gt?: Int
  totalVacancies_gte?: Int
